...
SET ROCKSDB_COMMON_CMAKE_PARAMS=-DWITH_MD_LIBRARY=ON -DROCKSDB_INSTALL_ON_WINDOWS=ON -DWITH_TESTS=OFF -DPORTABLE=ON -DCMAKE_INSTALL_PREFIX:PATH=%ROCKSDB_INSTALL_ROOT%
